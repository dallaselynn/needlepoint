defmodule Needlepoint.Sentiment.Vader do
  ...
  defp words_and_emoticons(text) do
  ...
  defp sift_sentiment_scores(valences) do
    Enum.reduce(
      valences,
  ...
  defp punctuation_emphasis_adjustment(text) do
  ...
  defp calculate_valence(lexicon, words, idx) do
